...
(function () {
    ...
    $.fn.smint = function (options) {
        ...
        return $('.smint a').each(function (index) {
            ...
            //Fill the menu
            var id = $(this).attr("id");
            //console.log($("div." + id).position().top - menuHeight, $("div." + id).height() + $("div." + id).position().top, id);
            ...
            var stickyMenu = function (direction) {
                ...
                */
                ...
                //maddy-change submenu background to transparent for first section
                if (optionLocs[0][0] <= scrollTop && scrollTop <= optionLocs[0][1]) {
                    $('.smint').addClass("transparentBackground");
                }
                else {
                    $('.smint').removeClass("transparentBackground");
                }
            };
